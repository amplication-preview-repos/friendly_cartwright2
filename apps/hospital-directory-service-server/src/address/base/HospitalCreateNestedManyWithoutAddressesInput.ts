...
@InputType()
class HospitalCreateNestedManyWithoutAddressesInput {
...
export { HospitalCreateNestedManyWithoutAddressesInput as HospitalCreateNestedManyWithoutAddressesInput };
